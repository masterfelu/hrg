...
void findChemFreezeoutParam_netKaonLambda_fluc()
{
	int n_expData;
	...
	cout << "               net-kaon and net-lambda fluctuations              " << '\n';
	cout << "-----------------------------------------------------------------" << '\n';
	...
	outFileFreeze.open("data/freezeout_netKaonLambda_fluc.dat");
	...
	if (writeToFile)
	{
		...
		cout << "Freeze out parameters saved to data/freezeout_netKaonLambda_fluc.dat..." << '\n';
		outFileFreeze.close();
	}
	...
	TCanvas *cl3 = new TCanvas("cl_freezeout_netKaonLambda_fluc","freezeout_netKaonLambda_fluc",550,400);
	...
	cl3->SaveAs("plots/freezeout_netKaonLambda_fluc.pdf");
}

int main()
{
	TApplication app {"app", nullptr, nullptr};
	findChemFreezeoutParam_netKaonLambda_fluc();
