...
void findChemFreezeoutParam_netProtonLambda_fluc()
{
	int n_expData;
	...
	cout << "             net-proton and net-lambda fluctuations              " << '\n';
	cout << "-----------------------------------------------------------------" << '\n';
	...
	outFileFreeze.open("data/freezeout_netProtonLambda_fluc.dat");
	...
	if (writeToFile)
	{
		...
		cout << "Freeze out parameters saved to data/freezeout_netProtonLambda_fluc.dat..." << '\n';
		outFileFreeze.close();
	}
	...
	TCanvas *cl3 = new TCanvas("cl3","freezeout_netProtonLambda_fluc",550,400);
	...
	cl3->SaveAs("plots/freezeout_netProtonLambda_fluc.pdf");
}

int main()
{
	TApplication app {"app", nullptr, nullptr};
	findChemFreezeoutParam_netProtonLambda_fluc();
