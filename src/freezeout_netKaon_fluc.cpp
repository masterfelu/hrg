...
void findChemFreezeoutParam_netKaon_fluc()
{
	int n_expData;
	...
	outFileFreeze.open("data/freezeout_netKaon_fluc.dat");
	...
	if (writeToFile)
	{
		...
		cout << "Freeze out parameters saved to data/freezeout_netKaon_fluc.dat..." << '\n';
		outFileFreeze.close();
	}
	...
	TCanvas *cl3 = new TCanvas("cl_freezeout_netKaon_fluc","freezeout_netKaon_fluc",550,400);
	...
	cl3->SaveAs("plots/freezeout_netKaon_fluc.pdf");
}

int main()
{
	TApplication app {"app", nullptr, nullptr};
	findChemFreezeoutParam_netKaon_fluc();
